...
# 1. What are the marks for the student with id number 42?


# 2. Which observation have marks over 0.96 on the midterm?


# 3. Which students got a 1.0 on Assignment 2?
...
Plot the exam marks as a histogram and a KDE on the same plot. The steps are broken down below to add each layer to the plot, but some code needs to be filled in. Try commenting any code you fill in.
